...
import { getCategories, deleteCategory } from '../../api/server';
          ...
          <nav className="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div className="sidebar-sticky pt-3">
              <ul className="nav flex-column">
                ...
                <li className="nav-item">
                  <Link className="nav-link active" to="#" style={{color:'black'}}><i className="fa fa-list-alt"></i> Danh mục</Link>
                </li>
                <li className="nav-item">
                    ...
                    <tr key={dm._id}>
                      ...
                      <td>
                        <button className="btn btn-success">
                          <Link to={`/editCate/${dm._id}`}><i className="fa fa-edit"></i> Edit</Link>
                        </button>
                      </td>
                      <td>
